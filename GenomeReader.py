...
genomes = read_fasta_file("genome1.fa") + read_fasta_file("genome2.fa") + read_fasta_file("genome3.fa") + read_fasta_file("genome4.fa")

#genome2 = translate_observations_to_indices(read_fasta_file("genome2.fa"))
trueann1 = read_fasta_file("true-ann1.fa")
trueanns = read_fasta_file("true-ann1.fa") + read_fasta_file("true-ann2.fa") + read_fasta_file("true-ann3.fa") + read_fasta_file("true-ann4.fa")
...
genome5 = translate_observations_to_indices(genome5)
genomes = translate_observations_to_indices(genomes)
ann1 = convertAnnToState(trueanns)
emProbs = countEmissionProbs(genomes,ann1)
transProbs = countTransisionProbs(ann1)
result = viterbi(init_probs_7_state,transProbs,emProbs,genome5)
learnann=translate_indices_to_path(result)
print(compute_accuracy(trueann5,learnann))
#print(result)
